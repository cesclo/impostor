...
function prepararRols() {
  ...
  if (paraulaPers) {
    paraula = paraulaPers;
  } else if (cat && WORDS_CATALA[cat]) {
    paraula = WORDS_CATALA[cat][Math.floor(Math.random() * WORDS_CATALA[cat].length)];
  } else {
    paraula = "pastís";
  }
...
function novaPartida() {
  ...
  document.getElementById("rolInfo").innerHTML = "";
  document.getElementById("rolInfo").className = "";
}
